...
//=============================================================================================================
#pragma mark -
#pragma mark Static Method Added By Mehul Akoliya

static MBProgressHUD *ProgressPopup = nil;

+ (MBProgressHUD *) ProgressPopup {
    if (ProgressPopup == nil) {
        AppDelegate* myDelegate = (((AppDelegate*) [UIApplication sharedApplication].delegate));
        
        ProgressPopup = [[MBProgressHUD alloc] initWithView:myDelegate.window]; 
        // ProgressPopup = [[MBProgressHUD alloc] initWithView:[[UIApplication sharedApplication] keyWindow]]; 
        [[[UIApplication sharedApplication] keyWindow] addSubview:ProgressPopup];
        
        ProgressPopup.dimBackground = YES;
    }
	return ProgressPopup;
}

+ (MBProgressHUD *)ShowProgressPopup {
    if (ProgressPopup == nil) {
        // ProgressPopup = [[MBProgressHUD alloc] initWithView:[[UIApplication sharedApplication] keyWindow]]; 
        ProgressPopup = [MBProgressHUD showHUDAddedTo:[[UIApplication sharedApplication] keyWindow] animated:YES];
        // [[[UIApplication sharedApplication] keyWindow] addSubview:ProgressPopup];
...
- (void)done {
    ...
    [ProgressPopup removeFromSuperview];
	ProgressPopup = nil;
}
